...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void addEmploy(EmployeeDTO employeeDTO) {
        ...
        employeeMapper.addEmploy(e);
    }

    @Override
    public PageResult PageQuery(EmployeePageQueryDTO employeePageQueryDTO) {
        PageHelper.startPage(employeePageQueryDTO.getPage(),employeePageQueryDTO.getPageSize());
        List<Employee> pageQuery = employeeMapper.PageQuery(employeePageQueryDTO);
        Page<Employee> pageQuery1= (Page<Employee>) pageQuery;
        return new PageResult(pageQuery1.getPages(),pageQuery1.getResult());
    }
